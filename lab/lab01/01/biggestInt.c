...
/**********************************************************************
   ...
   1. ln(2147483648) / ln(2) = 31
   2. same as int (31)
   3. yes
   4. His home computer is not as good, as bits could be 32/64 depending
   on the make of his computer
   5. For two's complement, the most negative number actually gives -1.
	Since it's a signed number, it'll stay in the negative region, and go to 
